# odin-recipes
Project 1: Recipes webpage - Foundations course, The Odin Project.
==============================================
...
By completing this project, I will:
 ...
 My goals from this point onward:
   - Be more consistent in Git commit message structures
   - Omit redundant or unnecessary information from commits with more consistency
   - Continue making small-level commits with descriptive messages
   - Focus on creating more original content for the site, not just pulling from other sources on the web